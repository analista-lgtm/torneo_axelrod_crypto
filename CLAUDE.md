...
| 17 | `src/vol_forecast_lab.py` | Fase 2: torneo de pronóstico de varianza a 1 día (QLIKE, walk-forward, DM vs HAR) — **gana GJR-GARCH** (12 de 18 mercados, DM sig. en 9); EWMA subcampeón; HIST-21 no gana en ninguno (la vol ES predecible); LightGBM pierde con claridad. Fase 3 pendiente: integrar el pronóstico al vol-targeting (Exp. 16). Requiere `arch`, `lightgbm`, `scikit-learn` | `data/multi_activo/vol_modelos.json` |
