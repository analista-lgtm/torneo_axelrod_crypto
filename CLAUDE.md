...
| 16 | `src/vol_monitor.py` | Tablero de Volatilidad (Fase 1): vol realizada multi-horizonte, Yang-Zhang/Parkinson (requiere OHLC, ahora conservado por `data_pipeline`), EWMA, vol-of-vol, percentiles, estructura temporal, correlación media, absorption ratio, VIX/OVX/GVZ y VRP, con alertas. Fases 2 (torneo HAR/GARCH/ML) y 3 (integración al vol-targeting) diseñadas en ROADMAP | `data/multi_activo/volatilidad.json` |
